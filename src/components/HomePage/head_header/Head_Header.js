        ...
        <div>
            <header className='header_section'>
                <nav className='navigation_bar'>
                    ...
                    <div className="ham_burger_nav_icon_wrapper" >
            ...
            <div ref = {sidebarRef} className='sidebar sidebar_popup ' id='sidebar_section'>
                ...
                <div className='sidebar_container' id='sidebar_container_id' >
                    <div>
                        ...
                        <span className="sidebar_close_icon_wrapper" id='sidebar_close_icon' >
